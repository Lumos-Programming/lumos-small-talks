    ...
    <div className="space-y-8">
      <div className="bg-white rounded-2xl shadow-xl p-6">
        <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
          ...
          <span>あなたの発表</span>
          <span className="text-lg text-muted-foreground font-normal">({weekId})</span>
        </h2>
        {myTalks.length === 0 ? (
          <div className="text-center py-12 bg-gradient-card rounded-xl border-2 border-dashed border-purple-200">
            <div className="text-5xl mb-3">📭</div>
            <p className="text-muted-foreground">この週の登録はまだありません</p>
            <p className="text-sm text-purple-600 mt-2">下のフォームから登録できます ↓</p>
          </div>
        ) : (
